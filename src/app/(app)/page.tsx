...
export default async function DashboardPage() {
  const [data, stageCounts, propertyCounts, settings, gmail] = await Promise.all([
    getDashboardData(),
    countClientsByStage(),
    countProperties(),
    getSettings(),
  ...
  const setupItems = [
    !gmail && { label: "Connect Gmail to see client email in the CRM", href: "/settings/gmail" },
    !env.whatsapp.configured && { label: "Configure WhatsApp Business to receive WhatsApp messages", href: "/settings/whatsapp" },
